          ...
          {isAuthenticated && (
            <>
              ...
              <Button variant="ghost" size="icon" className="relative h-8 w-8">
                ...
                <span className="absolute -right-0.5 -top-0.5 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-corporate-red text-[9px] font-bold text-white">3</span>
              </Button>
